...
public class CarsServiceDiscoveryServerImpl extends UnicastRemoteObject implements DiscoveryServerInterface {
    @Serial
    private static final long serialVersionUID = 1L;
    private final Map<String, String> serviceInstances; // serviceName -> address

    protected CarsServiceDiscoveryServerImpl() throws RemoteException {
        super();
    ...
    public void registerInstance(String serviceName, String address, int weight) throws RemoteException {
        // Implementação opcional se necessário para gerenciamento de peso
    }
    ...
    private String loadBalanceInstance() {
        ...
        for (Map.Entry<String, String> entry : serviceInstances.entrySet()) {
            ...
            CompletableFuture<QueueSizeResult> future = CompletableFuture.supplyAsync(() -> {
                try {
                    CarsServiceProtocolInterface service = (CarsServiceProtocolInterface) Naming.lookup(serviceAddress);
